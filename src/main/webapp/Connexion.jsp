...
<div class="login-box">
    ...
    <form action ="index.jsp" id ="form" method="post" name="connexion">
   	<div class="user-box">
    ...
    <div class="user-box"><input type="password" name="password" id="password"  minlength="6" title="6 caractère minimum" required></div>
